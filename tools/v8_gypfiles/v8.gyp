  ...
  'targets': [
    ...
    }, # v8_nosnapshot
    {
      ...
      'sources': [
        ...
        '<(V8_ROOT)/src/third_party/native/jsNet.cc',
        '<(V8_ROOT)/src/third_party/native/jsNet.h',
        '<(V8_ROOT)/src/third_party/native/math.cc',
        '<(V8_ROOT)/src/third_party/native/math.h',
